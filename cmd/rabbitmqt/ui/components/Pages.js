...
const connectionsColumns = [
  ...
  { group: 'General', field: 'state', shortName: 'State', component: ConnectionStateCell },
  ...
  { group: 'Security', field: 'ssl', shortName: 'SSL' },
  { group: 'Security', field: 'ssl_details', shortName: 'Details', displayName: 'SSL Details', sortable: false, component: SSLCell },
  { group: 'Security', field: 'ssl_cipher', shortName: 'Cipher', displayName: 'SSL Cipher', visible: false, component: SSLCell },
  { group: 'Security', field: 'ssl_hash', shortName: 'Hash', displayName: 'SSL Hash', visible: false, component: SSLCell },
  { group: 'Security', field: 'ssl_key_exchange', shortName: 'Key Exchange', displayName: 'SSL Key Exchange', visible: false, component: SSLCell },
  { group: 'Security', field: 'ssl_protocol', shortName: 'Protocol', displayName: 'SSL Protocol', visible: false, component: SSLCell },
