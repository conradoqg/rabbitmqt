...
const connectionsColumns = [
  ...
  { group: 'Traffic Count', field: 'cnt_stats', shortName: 'Stats', sortable: false, hideInFastMode: true, component: GroupTrafficCountCell },
  { group: 'Traffic Count', field: 'recv_cnt', shortName: 'Recv Count', visible: false, hideInFastMode: true, render: NumberRender },
  { group: 'Traffic Count', field: 'send_cnt', shortName: 'Send Count', visible: false, hideInFastMode: true, render: NumberRender },
  { group: 'Traffic Bytes', field: 'bytes_stats', shortName: 'Stats', sortable: false, hideInFastMode: true, component: GroupTrafficBytesCell },
  { group: 'Traffic Bytes', field: 'recv_oct', shortName: 'Recv Bytes', visible: false, hideInFastMode: true, render: ByteRender },
  { group: 'Traffic Bytes', field: 'send_oct', shortName: 'Send Bytes', visible: false, hideInFastMode: true, render: ByteRender },
  { group: 'Traffic Rate', field: 'rate_stats', shortName: 'Stats', sortable: false, hideInFastMode: true, component: GroupTrafficRateCell },
  { group: 'Traffic Rate', field: 'recv_oct_details.rate', shortName: 'Recv Rate', visible: false, hideInFastMode: true, render: RateRender },
  { group: 'Traffic Rate', field: 'send_oct_details.rate', shortName: 'Send Rate', visible: false, hideInFastMode: true, render: RateRender },
...
const exchangesColumns = [
  { group: 'General', field: 'vhost', shortName: 'Vhost', component: NameCell, width: 'max-w-[150px]' },
  { group: 'General', field: 'name', shortName: 'Name', component: NameCell, width: 'max-w-[300px]' },
  { group: 'Publish', field: 'message_stats', shortName: 'Stats', sortable: false, hideInFastMode: true, component: GroupPublishCell },
  { group: 'Publish', field: 'message_stats.publish_in_details.rate', shortName: 'In', hideInFastMode: true, visible: false, render: RateRender },
  { group: 'Publish', field: 'message_stats.publish_out_details.rate', shortName: 'Out', hideInFastMode: true, visible: false, render: RateRender },
...
const queuesColumns = [
  ...
  { group: 'Message Rate', field: 'message_stats', shortName: 'Stats', displayName: 'Message Rate Stats', sortable: false, hideInFastMode: true, component: GroupQueueMessageRateCell },
  { group: 'Message Rate', field: 'message_stats.publish_details.rate', shortName: 'Publish', visible: false, hideInFastMode: true, render: RateRender },
  { group: 'Message Rate', field: 'message_stats.ack_details.rate', shortName: 'Ack', visible: false, hideInFastMode: true, render: RateRender },
  { group: 'Message Rate', field: 'message_stats.redeliver_details.rate', shortName: 'Redeliver', visible: false, hideInFastMode: true, render: RateRender },
  { group: 'Message Rate', field: 'message_stats.deliver_details.rate', shortName: 'Deliver', visible: false, hideInFastMode: true, render: RateRender },
  { group: 'Message Rate', field: 'message_stats.deliver_get_details.rate', shortName: 'Deliver Get', visible: false, hideInFastMode: true, render: RateRender },
  { group: 'Message Rate', field: 'message_stats.deliver_no_ack_details.rate', shortName: 'Deliver No Ack', visible: false, hideInFastMode: true, render: RateRender },
  { group: 'Message Rate', field: 'message_stats.get_details.rate', shortName: 'Get Ack', visible: false, hideInFastMode: true, render: RateRender },
  { group: 'Message Rate', field: 'message_stats.get_empty_details.rate', shortName: 'Get Empty Ack', visible: false, hideInFastMode: true, render: RateRender },
  { group: 'Message Rate', field: 'message_stats.get_no_ack_details.rate', shortName: 'Get No Ack', visible: false, hideInFastMode: true, render: RateRender },
  ...
  { group: 'Messages', field: 'messages_paged_out', shortName: 'Paged Out', visible: false, hideInFastMode: true, render: NumberRender },
  { group: 'Messages', field: 'messages_persistent', shortName: 'Persistent', visible: false, hideInFastMode: true, render: NumberRender },
  { group: 'Messages', field: 'messages_ram', shortName: 'RAM', visible: false, hideInFastMode: true, render: NumberRender },
  { group: 'Messages', field: 'messages_ready', shortName: 'Ready', visible: false, render: NumberRender },
  { group: 'Messages', field: 'messages_ready_ram', shortName: 'Ready RAM', visible: false, hideInFastMode: true, render: NumberRender },
  { group: 'Messages', field: 'messages_unacknowledged', shortName: 'Unacked', visible: false, render: NumberRender },
  { group: 'Messages', field: 'messages_unacknowledged_ram', shortName: 'Unacked RAM', visible: false, hideInFastMode: true, render: NumberRender },
  { group: 'Bytes', field: 'bytes_stats', shortName: 'Stats', displayName: 'Bytes Stats', sortable: false, hideInFastMode: true, component: GroupBytesCell },
  { group: 'Bytes', field: 'message_bytes', shortName: 'Bytes', displayName: 'Total', visible: false, hideInFastMode: true, render: ByteRender },
  { group: 'Bytes', field: 'message_bytes_paged_out', shortName: 'Paged Out', visible: false, hideInFastMode: true, render: ByteRender },
  { group: 'Bytes', field: 'message_bytes_persistent', shortName: 'Persistent', visible: false, hideInFastMode: true, render: ByteRender },
  { group: 'Bytes', field: 'message_bytes_ram', shortName: 'RAM', visible: false, hideInFastMode: true, render: ByteRender },
  { group: 'Bytes', field: 'message_bytes_ready', shortName: 'Ready', visible: false, hideInFastMode: true, render: ByteRender },
  { group: 'Bytes', field: 'message_bytes_unacknowledged', shortName: 'Unacked', visible: false, hideInFastMode: true, render: ByteRender },
