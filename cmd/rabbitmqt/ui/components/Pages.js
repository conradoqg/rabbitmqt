...
import {
  ...
  GroupBytesCell,
  ArrayCell,
  QueuePurgeActionCell,
  GetMessagesActionCell,
  TimestampRender,
  NumberRender,
  ByteRender,
  RateRender,
...
const vhostsColumns = [
  ...
  { group: 'General', field: 'default_queue_type', shortName: 'Default Type', displayName: 'Default Queue Type' },
  ...
  { group: 'Messages', field: 'messages', shortName: 'Total', detailOf: true, render: NumberRender },
...
const queuesColumns = [
  ...
  { group: 'Bytes', field: 'message_bytes', shortName: 'Total', hideInFastMode: true, detailOf: true, render: ByteRender },
  ...
  { group: 'Actions', field: 'get', shortName: 'Get', component: GetMessagesActionCell },
  { group: 'Actions', field: 'purge', shortName: 'Purge', component: QueuePurgeActionCell },
];
...
const policiesColumns = [
  ...
  { group: 'General', field: 'apply-to', shortName: 'Apply To' },
