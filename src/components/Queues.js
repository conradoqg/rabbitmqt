...
const columns = [
  ...
  { group: 'Messages', field: 'messages_unacknowledged', shortName: 'Unack', displayName: 'Messages Unacknowledged', visible: false, render: NumberRender },
  { group: 'Messages', field: 'messages_unacknowledged_details', shortName: 'Unack Details', displayName: 'Messages Unacknowledged Details', visible: false, render: NumberRender },
  { group: 'Messages', field: 'messages_unacknowledged_ram', shortName: 'Unack RAM', displayName: 'Messages Unacknowledged RAM', visible: false, render: NumberRender },
  ...
  { group: 'Bytes', field: 'message_bytes_unacknowledged', shortName: 'Unack', displayName: 'Message Bytes Unacknowledged', visible: false, render: ByteRender },
